...
export function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Análise financeira, fluxo de caixa, orçamentos e projeções para tomada de decisão.",
      features: ["Análise financeira", "Fluxo de caixa", "Orçamentos", "Projeções financeiras"],
    },
    {
      icon: Shield,
      title: "Compliance e Auditoria",
      description: "Auditoria interna, compliance regulatório e adequação às normas contábeis.",
      features: ["Auditoria interna", "Compliance", "Normas contábeis", "Controles internos"],
    },
    {
      icon: Briefcase,
    ...
    },
    {
      ...
      description: "Folha de pagamento, admissões, demissões e gestão completa de recursos humanos.",
      features: ["Folha de pagamento", "Admissões/Demissões", "eSocial", "Gestão de RH"],
    },
  ]
