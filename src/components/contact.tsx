      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            Pronto para transformar a gestão financeira da sua empresa? Entre em contato conosco e descubra como podemos
            ajudar.
          </p>
        </div>
            ...
            <Card className=" h-[100%] flex flex-col relative">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="subject" placeholder="Como podemos ajudar?" className="py-5" />
                </div>
                ...
                <br />
                <br />
                <Button className="w-full bg-teal-600 hover:bg-teal-700 mt-10">Enviar Mensagem</Button>
              </CardContent>
            </Card>
          </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        contato@veriti.com.br
                        <br />
                        comercial@veriti.com.br
                      </p>
                    </div>
                  </div>
                </CardContent>
